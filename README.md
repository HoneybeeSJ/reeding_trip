...
팀장 : [이승재](https://github.com/HoneybeeSJ)
팀원 : [김지민](https://github.com/sokcho-kim) 
팀원 : [이진규](https://github.com/OnyX0000) 
...
| 역할                   | 팀원                           | 주요 담당 업무                                                                 |
|----------------------|------------------------------|-------------------------------------------------------------------------------|
| 리뷰 분석 및 시각화         | 이승재 | 앱 리뷰 데이터 분석, 워드 클라우드 기반 시각화 수행                                        |
| 리뷰 및 댓글 분석          | 김지민 | 유튜브 댓글 및 앱 리뷰 데이터 수집 및 분석, 워드 클라우드 시각화                            |
| 대중교통 및 관광객 데이터 분석 | 이진규 | 서울시 대중교통 이용 데이터 및 관광객 통계 분석, 인사이트 도출 및 시각화                        |
